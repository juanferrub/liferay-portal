...
public class TemplateResourceExternalizationTest {
	...
	public void testJournalTemplateResourceExternalization() throws Exception {
		...
		DDMTemplateResource ddmTemplateResource =
			new DDMTemplateResource(templateId, ddmTemplate);
		...
		DDMTemplateResource newDDMTemplateResource =
			new DDMTemplateResource();
