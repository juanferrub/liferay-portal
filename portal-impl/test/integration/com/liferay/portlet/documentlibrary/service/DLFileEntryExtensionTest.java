...
public class DLFileEntryExtensionTest extends BaseDLAppTestCase {
	...
	public void testAddFileEntryBasic10() throws Exception {
		try {
			DLAppServiceDataTestUtil.addFileEntry(false, "", "");
	...
	public void testAddFileEntryFalsePositives() throws Exception {
		...
		try {
			FileEntry tempFileEntry = DLAppServiceDataTestUtil.addFileEntry(
		...
		fileEntry = DLAppServiceDataTestUtil.addFileEntry(
			false, _STRIPPED_FILE_NAME, _STRIPPED_FILE_NAME);
	...
	public void testAddFileEntryWithExtension() throws Exception {
		...
		try {
			DLAppServiceDataTestUtil.addFileEntry(
				false, _FILE_NAME, _STRIPPED_FILE_NAME);
		...
		try {
			DLAppServiceDataTestUtil.addFileEntry(false, _FILE_NAME, "");
		...
		tempFileEntry = DLAppServiceDataTestUtil.addFileEntry(
			false, "Temp.txt", "");
		...
		try {
			DLAppServiceDataTestUtil.addFileEntry(
				false, _STRIPPED_FILE_NAME, _FILE_NAME);
