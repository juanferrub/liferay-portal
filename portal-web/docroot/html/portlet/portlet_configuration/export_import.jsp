...
<c:choose>
	<c:when test="<%= supportsLAR || supportsSetup %>">
		...
		<liferay-ui:error exception="<%= LocaleException.class %>">
			...
			<liferay-ui:message arguments="<%= new String[] {le.getSourceAvailableLocalesString(), le.getTargetAvailableLocalesString()} %>" key="the-available-languages-in-the-lar-file-x-do-not-match-the-portal's-available-languages-x" />
		</liferay-ui:error>
