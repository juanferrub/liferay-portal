...
<c:if test="<%= !portletName.equals(PortletKeys.ALERTS) || (portletName.equals(PortletKeys.ALERTS) && permissionChecker.hasPermission(scopeGroupId, AnnouncementsEntry.class.getName(), scopeGroupId, ActionKeys.ADD_ENTRY)) %>">
